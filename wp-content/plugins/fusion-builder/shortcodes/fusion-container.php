...
function fusion_builder_container( $atts, $content = '' ) {
	...
	if ( ( class_exists( 'Avada' ) && '100%' == Avada()->settings->get( 'site_width' ) ) || is_page_template( '100-width.php' ) || is_page_template( 'blank.php' ) || ( '1' == fusion_get_option( 'portfolio_width_100', 'portfolio_width_100', $c_page_id ) || 'yes' == fusion_get_option( 'portfolio_width_100', 'portfolio_width_100', $c_page_id ) && 'avada_portfolio' == get_post_type( $c_page_id ) ) || ( avada_is_portfolio_template() && 'yes' == get_post_meta( $c_page_id, 'pyre_portfolio_width_100', true ) ) || '100-width.php' == $page_template ) {
		$width_100 = true;
	}
