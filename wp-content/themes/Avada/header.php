...
<head>
   ...
   <link rel="shortcut icon" href="<?php echo get_stylesheet_directory_uri(); ?>/favicon.ico">	
	...
	<!--[if IE 11]>
<link rel="stylesheet" href="<?php bloginfo("stylesheet_directory");?>/ie11.css" type="text/css" media="screen" />
<![endif]-->
...
<script>
  ...
  ga('create', 'UA-100710698-1', 'auto');
  ga('send', 'pageview');

</script>
	<!--- Fix issue for internet explorer-->
	<script type="text/javascript">
